        ...
        <div className={DrinksStyle.wrapper}>  
            ...
            <div className={DrinksStyle.container}>
                <div className={DrinksStyle.leftDiv}>
                    <div>
                        <h3>BOROK</h3>
                        <div><p>Plébános rosé</p><span>400 Ft/dl</span></div>
                        <div><p>Plébános cuvée fehér</p><span>400 Ft/dl</span></div>
                        <div><p>Etyeki Kúriai Irsai Olivér</p><span>3.590 Ft/üveg</span></div>
                        
                        <div><p>Santa Cristina Campogrande Orvieto</p><span>3.990 Ft/üveg</span></div>
                        <div><p>Konyári Rosé</p><span>3.590 Ft/üveg</span></div>
                        <div><p>Ikon Cabarnet Sauvignon</p><span>3.990 Ft/üveg</span></div>
                        <div><p>Santa Cristina Le Maestrelle Toscana</p><span>4.290 Ft/üveg</span></div>
                    </div>
                    <div>
                        <h3>PEZSGŐK</h3>
                        <div><p>Hungária Extra Dry (0,2 l)</p><span>1.190 Ft</span></div>
                        <div><p>Hungária Extra Dry (0,75 l)</p><span>3.990 Ft</span></div>
                    </div>
                    <div>
                        ...
                        <div><div className={DrinksStyle.shot}><p>Dreher</p></div><div className={DrinksStyle.prices}><span>600 Ft</span><span>850 Ft</span></div></div>
                    </div>
                    <div>
                        <h3>ÜVEGES SÖRÖK</h3>
                        <div><p>Pilsner Urquell (0,5 l)</p><span>890 Ft</span></div>
                        <div><p>Peroni Nastro Azzuro (0,33 l)</p><span>690 Ft</span></div>
                        <div><p>Pécsi Gluténmentes (0,33 l)</p><span>690 Ft</span></div>
                        <div><p>Sörművek Búza Boxer  (0,33 l)</p><span>750 Ft</span></div>
                        <div><p>Sörművek Meggy Cekker (0,33 l)</p><span>790 Ft</span></div>
                        <div><p>Dreher 24 alkoholmentes (0,33 l)</p><span>690 Ft</span></div>
                    </div>
                    <div>
                ...
                <div className={DrinksStyle.rightDiv}>
                    <div>
                        <h3>ÜDÍTŐK (0,25 l)</h3>
                        <div><p>Coca-Cola, Coca-Cola zero</p><span>550 Ft</span></div>
                        <div><p>Fanta Narancs</p><span>550 Ft</span></div>
                        <div><p>Kinley Gyömbér</p><span>550 Ft</span></div>
                        <div><p>Kinley Tonic</p><span>550 Ft</span></div>
                        <div><p>Cappy Alma</p><span>550 Ft</span></div>
                        <div><p>Cappy Narancs</p><span>550 Ft</span></div>
                        <div><p>Natur Aqua ásványvíz (0,33 l)</p><span>450 Ft</span></div>
                        <div><p>Garai szóda (1 dl)</p><span>50 Ft</span></div>
                    </div>
                    <div>
                        <h3>KÁVÉK</h3>
                        <div><p>Espresso</p><span>490 Ft</span></div>
                        <div><p>Lungo</p><span>490 Ft</span></div>
                        <div><p>Espresso Macchiato</p><span>520 Ft</span></div>
                        <div><p>Cappuccino</p><span>650 Ft</span></div>
                        <div><p>Latte Macchiato</p><span>790 Ft</span></div>
                        
                        <div><p>Flat White</p><span>990 Ft</span></div>
                        <div><p>Baileys Latte</p><span>1450 Ft</span></div>
                        <div><p>Ír Káve</p><span>1450 Ft</span></div>
                        <ul>
                            <li><p>- Extra szirup (Kókusz,Karamell,Sütőtök)</p><span>150 Ft</span></li>
                          
                            <li><p>- Laktózmentes tej/dl</p><span>150 Ft</span></li>
                            <li><p>- Méz vagy tejszínhab</p><span>70 Ft</span></li>
                            <p>Kávéink koffeinmentes változatban is kérhetőek.</p>
                        </ul>
                        
                    </div>
                    <div>
                    <h3>FORRÓ ITALOK</h3>
                        <div><p>Tea (Earl grey,Mangós zöld tea, Erdei gyümölcsös)</p><span>690 Ft</span></div>
                        <div><p>Forró csoki</p><span>890 Ft</span></div>
                        <div><p>Forralt bor</p><span>950 Ft</span></div>
                        
                    </div>
                    <div>
                        <h3>LIMONÁDÉK (0,4L)</h3>
                        <div><p>Citrusos</p><span>950 Ft</span></div>
                        <div><p>Epres</p><span>950 Ft</span></div>
                        <div><p>Mangós</p><span>950 Ft</span></div>
                        <div><p>Feketeribizlis</p><span>950 Ft</span></div>
                        <div><p>Bodzás</p><span>950 Ft</span></div>
                    </div>
                </div>
            </div>
